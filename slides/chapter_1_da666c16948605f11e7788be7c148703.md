...
1) able to describe an auto-regression model with its mathematical model,
2) understand the various assumptions required for validating an implementation of AR model on a given time series,
