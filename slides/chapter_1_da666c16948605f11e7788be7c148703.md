...
`@script`
Now let's apply the AR model in python by importing statsmodel.tsa.ar_model.

We extract the return values of JJ-data and split it into train and test set. The last 8 quarters is our testset. Next we train the AR object on the train data. 
